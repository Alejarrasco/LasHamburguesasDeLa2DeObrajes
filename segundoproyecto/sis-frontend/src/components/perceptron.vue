<template>
    <div class="flex flex-col items-center justify-center p-8 bg-white rounded-lg shadow-xl">
      ...
      <div v-if="selectedColumn" class="mt-4">
        <input type="number" v-model="hiddenLayers" class="border border-gray-300 rounded p-2" min="1" placeholder="Número de capas ocultas (default: 2)" />
      </div>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      const hiddenLayers = ref<number>(2);
      ...
      return { columns, selectedColumn, hiddenLayers, handleFileUpload, submitData, report, isLoading, errorMessage };
    }
  });
  </script>
